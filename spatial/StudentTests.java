...
//        VizTree visualizer = new VizTree();
    ...
    public void test1() {
    	...
    	tree.insert(new KDPoint(-1, 6));
    	tree.insert(new KDPoint(0, 5));
    	tree.insert(new KDPoint(-1, 0));
    	tree.insert(new KDPoint(-10, -3));
    	tree.insert(new KDPoint(-4, -3));
    	tree.insert(new KDPoint(-6, -6));
    	tree.insert(new KDPoint(-4, -1));
    	tree.insert(new KDPoint(1, 3));
    	/*tree.insert(new KDPoint(20, 20));
    	tree.insert(new KDPoint(60, 80));
    	tree.insert(new KDPoint(80, 40));
    	tree.insert(new KDPoint(50, 30));
    	tree.insert(new KDPoint(70, 20));
    	tree.insert(new KDPoint(75, 10));
    	tree.insert(new KDPoint(90, 60));
    	
    	tree.delete(new KDPoint(75, 10));
    	tree.delete(new KDPoint(60, 80));
    	tree.delete(new KDPoint(20, 20));
    	tree.delete(new KDPoint(90, 60));
    	tree.delete(new KDPoint(20, 45));
    	tree.delete(new KDPoint(50, 30));*/
    	tree.delete(new KDPoint(-1, 6));
    	tree.delete(new KDPoint(2, 3));
    ...
    public void test2() {
    	...
    	tree.insert(new KDPoint(-4));
    	tree.insert(new KDPoint(0));
    	tree.insert(new KDPoint(1));
    	tree.insert(new KDPoint(6));
    	
    	tree.nearestNeighbor(new KDPoint(4));
    }
    ...
    public void test3() {
    	...
    	tree.kNearestNeighbors(1, new KDPoint(4));
    }
    
    @Test
    public void test4() {
    	PRQuadTree tree = new PRQuadTree(6, 2);
    	...
    	tree.insert(new KDPoint(-20, 20));
    	tree.insert(new KDPoint(-15, -5));
    	
    	tree.delete(new KDPoint(-15, 20));
    ...
    public void test5() {
    	...
    	tree.insert(new KDPoint(-1, 2, 3));
    	tree.insert(new KDPoint(-1, -9, 2));
    	tree.insert(new KDPoint(-4, 1, 0));
    	tree.insert(new KDPoint(-3, -8, -3));
    	tree.insert(new KDPoint(-3, -10, 1));
    	tree.insert(new KDPoint(-3, -8, 0));
    	tree.insert(new KDPoint(-6, 4, 8));
    	tree.insert(new KDPoint(-5, 6, 8));
    	tree.insert(new KDPoint(6, 0, -1));
    	tree.insert(new KDPoint(8, -2, 6));
    	tree.insert(new KDPoint(8, -2, 7));
    	tree.insert(new KDPoint(8, -1, 9));
    	tree.insert(new KDPoint(4, 1, -2));
    	
    	/*ArrayList<String> kdDescription = tree.treeDescription(false);
        CompactVizTree visualizer = new CompactVizTree(120,40,10);
        visualizer.drawBinaryTreeToFile(kdDescription,"test5_tree");*/
    	
    	tree.delete(new KDPoint(2, 3, -5));
    	tree.delete(new KDPoint(6, 0, -1));
    	tree.delete(new KDPoint(8, -2, 7));
    	tree.delete(new KDPoint(8, -2, 6));
    	tree.delete(new KDPoint(8, -2, 7));
    	tree.delete(new KDPoint(4, 1, -2));
    	
    	
    	ArrayList<String> kdDescription2 = tree.treeDescription(false);
        CompactVizTree visualizer2 = new CompactVizTree(120,40,10);
        visualizer2.drawBinaryTreeToFile(kdDescription2,"test5_tree2");
    	
    	tree.delete(new KDPoint(-1, 2, 3));
    }
}
